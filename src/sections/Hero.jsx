  ...
  return (
    <section>
        ...
        <div className="sm:w-1/2 border-r-[16px] -mr-4 border-t-[16px] border-b-[16px] sm:border-l-[16px] lg:border-l-[24px] lg:border-t-[24px] lg:border-b-[24px] lg:border-r-0 lg:-mr-0 lg:h-[600px] border-offWhite ">
                <img className="w-full h-full object-cover" src={heroImg} alt="A woman's hands gripping a nail polish bottle, highlighting her colorful and trendy nail art." />
              </div>
            <div className="flex flex-col items-start gap-6 sm:w-1/2">
                ...
                <Link to="/usluge/manikir" className="btn btn-outline"><span>saznajte više</span><GoArrowRight/>
                </Link>
            </div>
